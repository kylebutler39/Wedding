    ...
    return (
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
            ...
            <div className="text-center mb-12">
                <h1 
                className="text-6xl md:text-7xl mb-4 text-wedding-terracotta font-couple-name"
                >
                RSVP
                </h1>
                <div className="w-24 h-1 bg-wedding-terracotta mx-auto mb-6"></div>
                <p 
                className="text-xl md:text-2xl text-wedding-charcoal leading-relaxed font-info"
                >
            ...
            <div className="bg-white rounded-lg shadow-xl p-8 md:p-12 border border-wedding-terracotta/20">
                <div 
                className="text-center mb-8 font-info"
                >
                <p className="text-lg text-wedding-charcoal mb-6 leading-relaxed">
                    Your presence would mean the world to us. Please let us know if you'll be able to celebrate with us by filling out our RSVP form.
                </p>
                <p className="text-md text-wedding-sage mb-8">
                    Kindly respond by [Your RSVP Date]
                </p>
                </div>
                ...
                {/* Additional info */}
                <div 
                className="mt-10 pt-8 border-t border-wedding-terracotta/20 text-center font-info"
                >
